 ...
 * @brief Programa que cuenta las palabras y los caracteres con sus tipos de una cadena dada por el usuario
 * @version 0.1
 * @date 2023-04-28
 * 
 * @copyright GPL v3
...
int main()
{
    ...
    for (int i = 0; cadena[i] != '\0'; i++) //Recorre toda la cadena
    {
